...
export const esquemaLoginUsuario = z.object({
  ...
  export const esquemaActualizarUsuario = z.object({
    ...
    email: z.string().trim().min(1, "El email es obligatorio").email("Correo electrónico inválido").optional(),
    contrasenia: z.string().min(6, "La contraseña debe tener al menos 6 caracteres").optional(),
    rol: z.enum(['ADMIN', 'CLIENTE']).optional()
  })